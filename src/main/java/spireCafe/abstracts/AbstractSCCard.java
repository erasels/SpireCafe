...
public abstract class AbstractSCCard extends CustomCard {
    ...
    public AbstractSCCard(final String cardID, final int cost, final CardType type, final CardRarity rarity, final CardTarget target, final CardColor color) {
        this(cardID, null, cost, type, rarity, target, color);
    }

    public AbstractSCCard(final String cardID, final String zoneID, final int cost, final CardType type, final CardRarity rarity, final CardTarget target) {
        this(cardID, zoneID, cost, type, rarity, target, CardColor.COLORLESS);
    }

    public AbstractSCCard(final String cardID, final String zoneID, final int cost, final CardType type, final CardRarity rarity, final CardTarget target, final CardColor color) {
        this(cardID, cost, type, rarity, target, color, getCardTextureString((zoneID != null ? zoneID + "/" : "") + cardID.replace(modID + ":", ""), type));
    }

    public AbstractSCCard(final String cardID, final int cost, final CardType type, final CardRarity rarity, final CardTarget target, final CardColor color, final String textureString) {
