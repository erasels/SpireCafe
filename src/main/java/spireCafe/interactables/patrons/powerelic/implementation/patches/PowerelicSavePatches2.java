...
public class PowerelicSavePatches2 {
    public static class Anniv7PowerelicTemporaryDuplicateRelics implements CustomSavable<ArrayList<CardedRelicSaveData>> {
        public final static String SaveKey = "Anniv7PowerelicTemporaryDuplicateRelics";
